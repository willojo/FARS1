...
# Make FARS Filename.
#
# code{make_filename} makes a properly formatted FARS filename given a year as input.
#
# This function takes a year as input and produces a valid FARS filename. Thisfunction does not check whether
# the file actually exists, or if the year is reasonable -- you could enter any number
# you like.
#
# @param year An integer, or a string or numeric that can be coerced to a string, of the year of interest.
# @return this function returns a string that is the proper FARS data filename for the given year.
# Will return a filename with NA for the year slot in the name if the year parameter cannot be coerced to an integer.
# @examples
...
#  year's FARS data.  If an invalid year is given, the corresponding list will be NULL.
# @examples
